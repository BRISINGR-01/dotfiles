return {
  ...
  opts = {
    -- If you are also using neotree, you may prefer not to bring it up when opening a directory
    {
    ...
    -- when yazi is closed with no file chosen, change the Neovim working directory to the directory that yazi was in before it was closed.
    change_neovim_cwd_on_close = true,

    highlight_groups = {
      hovered_buffer = nil,                   -- See https://github.com/mikavilpas/yazi.nvim/pull/180
      hovered_buffer_in_same_directory = nil, -- See https://github.com/mikavilpas/yazi.nvim/pull/351
    },

    floating_window_scaling_factor = 0.9,

    yazi_floating_window_winblend = 0,       -- the transparency of the yazi floating window (0-100). See :h winblend

    yazi_floating_window_border = "rounded", -- 'none', 'rounded', 'single', 'double', 'shadow', etc. For more information, see :h nvim_open_win

    yazi_floating_window_zindex = nil,       -- the zindex of the yazi floating window. Can be used to make the yazi window fullscreen. See `:h nvim_open_win()` for more information.
